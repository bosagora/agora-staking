...
export const PRYSM_INSTALLATION_URL     = process.env.REACT_APP_PRYSM_INSTALLATION_URL   || 'https://docs.bosagora.org/validator-start/install-an-agora-node/agora-cl';
