      ...
      <StepsContainer>
        <ScrollAnimation animateIn="fadeInUp" animateOnce>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                'The AGORA upgrades will only be successful if validators understand the risks and responsibilities.',
            })}
          >
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={300}>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                "You'll need to run an execution client (Agora-el) as well as a consensus client (Agora-cl) to become a validator. Take a look at the checklist to prepare yourself and your equipment.",
            })}
          >
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={150}>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                'We strongly recommend you go through the entire process on a testnet first to get comfortable before risking real BOA.',
            })}
          >
            {IS_MAINNET ? (
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={150}>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                "Once you're comfortable, you'll go through generating your keys and depositing your BOA.",
            })}
          >
